...
@elseif(\Illuminate\Support\Carbon::parse($data->enddate)->format("Y-m-d") < $dateNowString) @section('content') <div class="container-fluid">
    <div class="title">
        <h4 class="fw-bold">Pendaftaran</h4>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-card-sky m-3 p-3">
            ...
            <form action="{{route('pendaftaran.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="surat_pernyataan" class="form-label">Unduh Template Surat Pernyataan<span class="text-danger">*</span> <a href="{{asset('file/'.$surat->nama_berkas)}}" download="">Unduh</a></label>
                    <div class="col-sm-3">
